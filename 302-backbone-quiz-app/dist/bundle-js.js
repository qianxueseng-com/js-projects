...
/***/ function(module, exports, __webpack_require__) {
	...
	app.View = Backbone.View.extend({
		el: "#warped",
		initialize: function() {
			var CardView = __webpack_require__(4);
			var CardCollection = __webpack_require__(5);

			var OTHER_SCARDS, QUIZ_CARDS;
			app.list = new CardCollection(__webpack_require__(7));
