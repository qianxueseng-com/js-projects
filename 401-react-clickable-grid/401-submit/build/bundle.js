...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputView = __webpack_require__(163);
	...
	// Necessary for JSX
	// Import CSS
	_reactDom2.default.render(_react2.default.createElement(_inputView2.default, null), document.getElementById('app-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  width: 100%; }\n\n.input-n {\n  text-align: center; }\n\n#n-size {\n  width: 23%;\n  height: 26px;\n  font-size: 18px;\n  border: 1px solid #337ab7;\n  -moz-border-radius: 5px;\n  -webkit-border-radius: 5px;\n  border-radius: 5px; }\n\n#n-submit {\n  cursor: pointer;\n  font-size: 18px;\n  height: 30px;\n  border: 1px solid #337ab7;\n  color: white;\n  background-color: #337ab7;\n  -moz-border-radius: 5px;\n  -webkit-border-radius: 5px;\n  border-radius: 5px; }\n\n.main {\n  width: 80%;\n  margin: auto; }\n\n.main ul {\n  padding: 0;\n  display: flex;\n  list-style: none;\n  margin: 10px; }\n\n.main ul li:before {\n  content: \"\";\n  display: inline-block;\n  padding-bottom: 100%;\n  vertical-align: middle; }\n\n.main ul li {\n  flex: 1;\n  margin: 0 5px;\n  text-align: center;\n  font-weight: bold;\n  background-color: #f0ad4e;\n  cursor: pointer;\n  opacity: 0.8; }\n\n.main ul li:hover {\n  opacity: 1;\n  -webkit-box-shadow: 0 0 15px #46b8da;\n  -moz-box-shadow: 0 0 15px #46b8da;\n  box-shadow: 0 0 10px #46b8da; }\n\n.message {\n  text-align: center;\n  color: red; }\n\n.message h3 {\n  font-weight: bold; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gridView = __webpack_require__(164);
	
	var _gridView2 = _interopRequireDefault(_gridView);
	
	var _messageView = __webpack_require__(165);
	...
	var InputView = (function (_React$Component) {
	  _inherits(InputView, _React$Component);
	
	  function InputView(props) {
	    _classCallCheck(this, InputView);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InputView).call(this, props));
	
	    _this.handleChange = function (event) {
	      var inputN = event.target.value;
	      var judgeMessage = null;
	      ...
	      _this.inputN = inputN;
	      _this.judgeMessage = judgeMessage;
	    };
	
	    _this.handleClick = function () {
	      _this.setState({
	        n: _this.inputN,
	        message: _this.judgeMessage
	      });
	    };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'input-n' },
	          _react2.default.createElement('input', { type: 'text', id: 'n-size', value: null, placeholder: '请输入n的值', onChange: this.handleChange, onKeyDown: this.handleKeyDown }),
	          _react2.default.createElement(
	            'button',
	            { value: 'submit', id: 'n-submit', onClick: this.handleClick, onKeyDown: this.handleKeyDown },
	            'submit'
	          )
	        ),
	        _react2.default.createElement(_messageView2.default, { message: this.state.message }),
	        _react2.default.createElement(_gridView2.default, { n: this.state.n })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridElement = (function (_React$Component) {
	  _inherits(GridElement, _React$Component);
	
	  function GridElement() {
	    _classCallCheck(this, GridElement);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GridElement).apply(this, arguments));
	  }
	  ...
	  _createClass(GridElement, [{
	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < n; i++) {
	        var number = rowIndex * n + i + 1;
	        gridRow.push(_react2.default.createElement(
	          'li',
	          { id: number, key: 'li' + number, style: style.fontStyle },
	          number
	        ));
	      }
	...
	var GridView = (function (_React$Component2) {
	  _inherits(GridView, _React$Component2);
	  ...
	  _createClass(GridView, [{
	    ...
	    value: function render() {
	      ...
	      var fontSize = Math.ceil(150 / n);
	
	      for (var i = 0; i < n; i++) {
	        grids.push(_react2.default.createElement(GridElement, { n: n, rowIndex: i, key: 'Grid' + i, fontSize: fontSize }));
	      }
