<component name="InspectionProjectProfileManager">
  <profile version="1.0">
    ...
    <inspection_tool class="JSDeclarationsAtScopeStart" enabled="true" level="WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="RubyDefParenthesesInspection" enabled="true" level="WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="RubyTooManyInstanceVariablesInspection" enabled="true" level="WARNING" enabled_by_default="true">
      <option name="m_limit" value="15" />
    </inspection_tool>
    <inspection_tool class="RubyTooManyMethodsInspection" enabled="true" level="INFO" enabled_by_default="true">
      <option name="m_limit" value="45" />
    </inspection_tool>
